...
brew install make gcc perl openssl@3 pcre2 zlib
...
./configure \
  ...
  --with-cc-opt="-mmacosx-version-min=10.15 -DFD_SETSIZE=1024 -I$(brew --prefix openssl@3)/include -I$(brew --prefix zlib)/include" \
  --with-ld-opt="-L$(brew --prefix openssl@3)/lib -L$(brew --prefix zlib)/lib"
